...
Info  : https://brightdata.de/products/insights/price-tracker/coles
"""
...
# https://brightdata.de/products/web-scraper/coles
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Coles scraper at: https://brightdata.de/products/web-scraper/coles\n"

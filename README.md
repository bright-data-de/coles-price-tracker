...
[![Coles Price Tracker](https://img.shields.io/badge/Coles%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/coles)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/coles)

Coles-Preisverfolgung in Echtzeit – eine der beiden größten australischen Supermarktketten. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit dem AI Scraper Builder von Bright Data.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/coles)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Verfolgen Sie die Lebensmittelpreisinflation** über Kategorien hinweg bei Coles
...
> **Ab $250/Monat – [Individuelles Angebot anfordern →](https://brightdata.de/products/insights/price-tracker/coles)**

---

## Option 2: Erstellen Sie Ihren eigenen Coles Scraper

Keine vorgefertigte Coles-Scraper-API? Kein Problem. Der **AI Scraper Builder** von Bright Data generiert mit nur wenigen Klicks einen benutzerdefinierten Coles-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren Coles-Scraper in wenigen Minuten

**[Öffnen Sie den Coles AI Scraper Builder →](https://brightdata.de/products/web-scraper/coles)**
...
- Eine **Web Scraper ID** für Coles (aus dem obigen Build-Schritt)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/coles-price-tracker.git
...
3. **Konfigurieren Sie die Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/coles)
...
Sobald Ihr Coles-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Coles-Produkt-URLs, um strukturierte Preisdaten abzurufen:
...
Sammeln Sie alle Produkte von einer Coles-Kategorieseite:
...
- 🌟 [Coles Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/coles)
- 🏗️ [Build a Coles Scraper](https://brightdata.de/products/web-scraper/coles)
